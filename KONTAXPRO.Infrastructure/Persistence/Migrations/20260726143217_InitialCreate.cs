        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_terceros_consumidor_final_protegido", "numero_identificacion <> '9999999999999' OR (razon_social = 'CONSUMIDOR FINAL' AND estado = 1)");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_empresas_terceros_tipo", "es_cliente OR es_proveedor");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_compras_documento", "(tipo_compra = 'FACTURADA' AND tipo_comprobante_id IS NOT NULL AND numero_documento IS NOT NULL) OR (tipo_compra = 'SIN_FACTURA')");
                    table.CheckConstraint("ck_compras_tipo", "tipo_compra IN ('FACTURADA', 'SIN_FACTURA')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_compras_detalles_producto", "(producto_presentacion_id IS NULL OR producto_id IS NOT NULL) AND (bodega_id IS NULL OR producto_id IS NOT NULL)");
                    table.ForeignKey(
